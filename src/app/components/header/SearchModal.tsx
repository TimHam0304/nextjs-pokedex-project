            ...
            >
              {filteredQueryList.map((entry) => (
                <Link
                  ...
                  onClick={closeModal}
                  className="flex items-center pl-2 min-h-10 hover:bg-neutral-200 dark:hover:bg-neutral-700 rounded-md focus-visible:bg-neutral-200 dark:focus-visible:bg-neutral-700 outline-none"
                  key={entry}
                >
