  ...
  return (
    <div>
      <Link
        ...
        className="block bg-white dark:bg-neutral-800 rounded-2xl p-6 shadow-lg shadow-indigo-700/10 dark:shadow-inherit hover:shadow-none gray-outline-indigo-focus-outline hover:bg-neutral-100 dark:hover:bg-neutral-700 transition-all"
      >
        <Image
          src={
      ...
      <LikeAndShareBox name={Pokemon.name} />
    </div>
  );
}
